 ...
 * 	NONE - нет команды
 * 	G00 - неинтерполяционное движение до 8 осей
 * 	G01 - интерполяционное линейное движение до 8 осей
 * 	G02 - интерполяционное круговое движение по часовой стрелки - 2 оси
 * 	G03 - интерполяционное круговое движение против часовой стрелки - 2 оси
 */
typedef enum
{
	NONE = -1,
